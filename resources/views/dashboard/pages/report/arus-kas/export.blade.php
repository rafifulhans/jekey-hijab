...
<body>
    <header>
        <h3 class="title_report">Arus Kas</h3>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td class="text-dark fw-bold">Arus Kas dari Operasi:</td>
                    <td></td>
                </tr>
                @foreach ($arus_kas['masuk'] as $ak)
                    ...
                    <tr>
                        <td>{{ $nama_akun }}</td>
                        <td class="badge badge-success" style="text-align: right;">{{ Number::currency($ak->total, 'IDR', 'id_ID') }}</td>
                    </tr>
                @endforeach
                ...
                @foreach ($arus_kas['keluar'] as $ak)
                    ...
                    <tr>
                        <td>{{ $ak->nama_akun }}</td>
                        <td class="badge badge-danger" style="text-align: right;">{{ Number::currency($ak->total, 'IDR', 'id_ID') }}</td>
                    </tr>
                @endforeach
