...
<body>
    <header>
        <h3 class="title_report">Jurnal Umum</h3>
                            ...
                            @foreach ($jum as $key => $ju)
                                <tr>
                                    ...
                                    @switch($ju->type)
                                        @case(1)
                                            <td>
                                            <span class="badge badge-success">{{ Number::currency($ju->total, 'IDR', 'id_ID') }}</span>
                                            </td>
                                            <td>-</td>
                                            @break
                                        @case(2)
                                            <td>-</td>
                                            <td>
                                            <span class="badge badge-danger">{{ Number::currency($ju->total, 'IDR', 'id_ID') }}</span>
                                            </td>
                                            @break
                                    @endswitch
                                </tr>
