...
<body>
    <header>
        <h3 class="title_report">Jurnal Transaksi</h3>
                ...
                @foreach ($jurnal_transaksi as $jt)
                    <tr>
                        ...
                        @switch($jt->type)
                            @case(1)
                                <td>
                                  <span class="badge badge-success">{{ Number::currency($jt->total, 'IDR', 'id_ID') }}</span>
                                </td>
                                <td>-</td>
                                @break
                            @case(2)
                                <td>-</td>
                                <td>
                                  <span class="badge badge-danger">{{ Number::currency($jt->total, 'IDR', 'id_ID') }}</span>
                                </td>
                                @break
                        @endswitch
