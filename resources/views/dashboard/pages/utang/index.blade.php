<x-dashboard>
    ...
    @if (auth()->user()->role == 3)
        <div class="d-flex justify-content-end align-items-center mb-3">
            <a href="{{ route('utang.tambah') }}" class="btn btn-primary m-1">Tambah</a>
        </div>
    @endif
            ...
            <div class="card-body">
                ...
                <div class="table-responsive mt-4">
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                        <thead>
                            <tr>
                                <th class="text-start">Kode utang</th>
                        ...
                        <tbody>
                            @foreach($utang as $piu)
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->role == 3)
                                            <a href="{{ route('utang.edit', $piu->id_utang) }}"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <form action="{{ route('utang.hapus', $piu->id_utang) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
