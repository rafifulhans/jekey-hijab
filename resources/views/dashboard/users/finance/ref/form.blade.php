    ...
    <div class="col-12 col-md-6 col-lg-6">
        <x-form title="{{ $page_meta['title'] }}" action="{{ $page_meta['action'] }}" type="{{ $page_meta['type'] }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_akun" name="nama_akun" value="{{ old('nama_akun') ?? $ref->nama_akun }}">
                @error('nama_akun')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="kode" name="kode" max="5" value="{{ old('kode') ?? $ref->kode }}">
                @error('kode')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>  
